...
//
//  Created by Егор Филиппов on 25.04.2022.
//
...
extension TimerWorkoutViewController {
    ...
    //MARK - рисуется зеленая линия в анимации круга
...
//
//    private let startWorkoutTimerView = StartWorkoutTimerView()
//
//    private lazy var finishButton: UIButton = {
//        let button = UIButton(type: .system)
//        button.setTitle("FINISH", for: .normal)
...
//        view.addSubview(startWorkoutTimerView)
//        view.addSubview(finishButton)
//    }
//
//    @objc private func closeButtonTapped() {
...
//            detaildLabel.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant: 30)
//        ])
//        NSLayoutConstraint.activate([
//            startWorkoutTimerView.topAnchor.constraint(equalTo: detaildLabel.bottomAnchor, constant: 3),
//            startWorkoutTimerView.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant: 30),
//            startWorkoutTimerView.trailingAnchor.constraint(equalTo: view.trailingAnchor, constant: -30),
//            startWorkoutTimerView.heightAnchor.constraint(equalToConstant: 270)
//        ])
//        NSLayoutConstraint.activate([
//            finishButton.topAnchor.constraint(equalTo: startWorkoutTimerView.bottomAnchor, constant: 30),
