...
//
//  Created by Егор Филиппов on 11.04.2022.
//
...
//        button.setTitle("START", for: .normal)
    ...
    weak var cellStartWorkoutDelegae: StartWorkoutProtocol?
    ...
    @objc private func startButtonTapped() {
        cellStartWorkoutDelegae?.startButtonTapped(model: workoutModel)
    }
